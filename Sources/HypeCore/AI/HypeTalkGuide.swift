...
public enum HypeTalkGuide {
    ...
    public static let llmContext: String = """
        ...
        **AI / models:**
        ...
        - Target compatibility: call `list_target_profiles`, `get_part_target_availability`, `preview_layout_profile`, `plan_stack_deployment`; `layoutPolicy`: `fixed`/`scaleToFit`/`stretchToFill`.
