...
public struct Parser: Sendable {
    ...
    private mutating func parsePrimary() throws -> Expression {
        ...
        case .identifier where ["label", "shape", "audio", "chart", "calendar", "pdf", "map", "colorwell", "color_well", "stepper", "slider", "toggle", "segmented", "recorder", "audiorecorder", "scene3d", "scene3D", "model3d", "model3D", "progressview", "progress", "gauge", "link", "menu", "searchfield", "search", "divider"].contains(current.value.lowercased()):
