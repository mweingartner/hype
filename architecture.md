...
files, plus generated `.hype` package byte counts and import durations for live
import profiling; these are optional legacy-import report metadata and do not require a
